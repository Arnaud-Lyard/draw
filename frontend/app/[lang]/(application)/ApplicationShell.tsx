...
export default function ApplicationShell({
  ...
  const unauthenticatedNavigation = [
    { name: translations.unauthenticatedNav.login, href: "/login" },
    { name: translations.unauthenticatedNav.register, href: "/register" },
  ];
          ...
          <div className="flex h-16 justify-between">
            ...
            {loading ? (
              ...
              <div className="hidden sm:ml-6 sm:flex sm:items-center space-x-4">
                ...
                >
                  {translations.unauthenticatedNav.login}
                </Link>
                <Link
                  href={`/${lang}/register`}
                  className="rounded-md bg-sky-600 px-3 py-2 text-sm font-semibold text-white hover:bg-sky-500 shadow-sm"
                >
                  {translations.unauthenticatedNav.register}
                </Link>
              </div>
            )}
          ...
          {loading ? (
            ...
            <div className="border-t border-gray-200 pt-4 pb-3 dark:border-white/10">
              <div className="flex items-center px-4">
                ...
                <Link
                  href={`/${lang}/login`}
                  className="text-base font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-800 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-white"
                >
                  {translations.unauthenticatedNav.login}
                </Link>
                <div className="pl-2">
